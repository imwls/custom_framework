...
LOCAL_PACKAGE_NAME := sunmi-res
LOCAL_CERTIFICATE := platform

LOCAL_AAPT_FLAGS := --auto-add-overlay
#LOCAL_AAPT_FLAGS += --private-symbols com.sunmi.internal
LOCAL_RESOURCE_DIR := $(addprefix $(LOCAL_PATH)/, res)

# Tell aapt to create "extending (non-application)" resource IDs,
# since these resources will be used by many apps.
LOCAL_AAPT_FLAGS += -x10

LOCAL_MODULE_TAGS := optional

# frameworks resource packages don't like the extra subdir layer
#
# Modify build/core/base_rules.xml and Add this Feature
#
