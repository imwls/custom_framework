...
public class ApplicationsState {
    ...
    static ApplicationsState sInstance;
     ...
     /**
     * get the object of ApplicationsState, this is singleton
     * <p><pre>{@code
     * Using:
     * ApplicationsState obj = ApplicationsState.getInstance(Application);
     * }</pre>
     * @param app app object
     * @return ApplicationsState ApplicationsState's object
     */
    ...
    /**
     * get background looper, thread
     * <p><pre>{@code
     * Using:
     * Looper looper = ApplicationsState.getInstance(Application).getBackgroundLooper();
     * }</pre>
     * @return Looper the background looper
     */   
     ...
     * <p><pre>{@code
     * Using:
     * Session session = ApplicationsState.getInstance(Application).newSession(Callbacks);
     * }</pre>
    ...
    /**
     * send MSG_LOAD_ENTRIES to get all installed applications of state
     */
    void doResumeIfNeededLocked() {
        /*if (mResumed) {
            android.util.Log.e("wjx1","wjx--------Session----doResumeIfNeededLocked------return---");
            return;
        }*/
        mResumed = true;
    ...
    /**
     * judge whether the device has disabled apps
     * <p><pre>{@code
     * Using:
     * boolean b = ApplicationsState.getInstance(Application).haveDisabledApps();
     * }</pre>
     * @return boolean if true, it show the device has disabled apps
     */
    ...
    /**
     * get AppEntry according to packageName and uid
     * <p><pre>{@code
     * Using:
     * AppEntry entry = ApplicationsState.getInstance(Application).getEntry(String, int);
     * }</pre>
     * @param packageName  the app's package name
     * @param userId                common user id
     * @return AppEntry             AppEntry object
     */     
     ...
     * <p><pre>{@code
     * Using:
     * ApplicationsState.getInstance(Application).ensureIcon(AppEntry);
     * }</pre>
     * @param entry  can see {@link #getEntry(String, int)}
     */
    ...
    /**
     * get the size of the application according to packageName and userId
     * <p><pre>{@code
     * Using:
     * ApplicationsState.getInstance(Application).requestSize(String, int);
     * }</pre>
     * @param packageName  the app's package name
     * @param userId                common user id
     */
    ...
    /**
     * get the cache size of the application
     * <p><pre>{@code
     * Using:
     * long size = ApplicationsState.getInstance(Application).sumCacheSizes();
     * }</pre>
     * @return long  all cache size
     */
    long sumCacheSizes() {
        long sum = 0;
    ...
    /**
     * get the position of the packageName int the list of mApplications
     * <p><pre>{@code
     * Using:
     * int index = ApplicationsState.getInstance(Application).indexOfApplicationInfoLocked(String, int);
     * }</pre>
     * @param pkgName   the application package name
     * @param userId        common user id
     * @return int                index of appliction locked
     */
    ...
    /**
     * add the list of mAppEntries according to pkgName and userId
     * <p><pre>{@code
     * Using:
     * ApplicationsState.getInstance(Application).addPackage(String, int);
     * }</pre>
    ...
    /**
     * remove the list of mAppEntries according to pkgName and userId
     * <p><pre>{@code
     * Using:
     * ApplicationsState.getInstance(Application).removePackage(String, int);
     * }</pre>
     * @param pkgName   package name
     * @param userId         the name adn id, see addPackage(String, int)
     */
    ...
    /**
     * remove the invalidate package from the list of mApplications
     * <p><pre>{@code
     * Using:
     * ApplicationsState.getInstance(Application).invalidatePackage(String, int);
     * }</pre>
     * @param pkgName  package name
     * @param userId        commont user id
     */
    ...
    /**
     * add the info of Application to the list of mAppEntries
     * @param info
     * @return AppEntry
     */
    ...
    /**
     * get the total internal size of the application
     * @param ps
     * @return long
     */
    ...
    /**
     * get the total external size of the application
     * @param ps
     * @return long
     */
    ...
    /**
     * convert the data type (long) of size to String
     * @param size
     * @return String
     */
    ...
    /**
     * remove space an to lower
     * <p><pre>{@code
     * Using:
     * String str = ApplicationsState.normalize(String);
     * }</pre>
    ...
    public class Session {
        ...
        /**
         * the method is used to get application list
         */
        public void resume() {
